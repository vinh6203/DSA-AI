...
def basic_evaluate(board: ConnectFourBoard):
    """
...
def minimax_find_board_value(board, depth, eval_fn,
                             ...
                             is_terminal_fn=is_terminal, is_max_player_turn=False):
    """
    ...
    if is_max_player_turn:
        ...
        for move, new_board in get_next_moves_fn(board):
            val = minimax_find_board_value(new_board, depth-1, eval_fn,
                                                get_next_moves_fn, is_terminal_fn, is_max_player_turn=False)
        ...
        for move, new_board in get_next_moves_fn(board):
            val = minimax_find_board_value(new_board, depth-1, eval_fn,
                                                get_next_moves_fn, is_terminal_fn, is_max_player_turn=True)
            if best_val == None or val < best_val:
                best_val = val
